...
<div class="container-fluid min-vh-100 d-flex justify-content-center align-items-center">
    ...
    <div class="card-body-editar-ficha">
        <h1 class="page-title">Agregar Nueva Especialidad</h1>
        <div class="dashboard-header text-center mb-5">
        <p class="fs-5">Completa el formulario para agregar una nueva especialidad al sistema.</p>
    </div>
    ...
    <div class="form-wrapper">
        ...
        <form method="POST" action="{{ route('specialties.store') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" id="name" name="name" class="form-input" placeholder="Ingresa el nombre de la especialidad" value="{{ old('name') }}" required>
            </div>
